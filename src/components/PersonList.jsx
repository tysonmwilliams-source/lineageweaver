          ...
          <div className="p-4">
            <div className="flex items-start justify-between">
              ...
              <div className="flex-1">
                ...
                {/* ═════════════════════════════════════════════════════════
                    🔗 TREE-CODEX INTEGRATION: Biography Indicator
                    ═════════════════════════════════════════════════════════
                    Shows a 📖 badge when this person has a Codex entry.
                    The badge helps users identify who has biography content.
                    ═════════════════════════════════════════════════════════ */}
                {person.codexEntryId && (
                  <span 
                    className="inline-flex items-center px-2 py-1 text-xs rounded ml-2"
                    style={{
                      backgroundColor: 'rgba(201, 162, 39, 0.15)',
                      color: '#8b6914'
                    }}
                    title="Has Codex biography entry"
                  >
                    📖 Biography
                  </span>
                )}

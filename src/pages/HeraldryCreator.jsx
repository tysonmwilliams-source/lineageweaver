...
// ═══════════════════════════════════════════════════════════════════════════════
// SEPARATED: FIELD DIVISIONS vs ORDINARIES
// ═══════════════════════════════════════════════════════════════════════════════

/**
 * FIELD_DIVISIONS - Patterns that divide the shield's background
 * These set the base layer colors/patterns
 */
...
/**
 * ORDINARIES - Shapes placed ON TOP of the field
 * These are independent layers with their own tinctures
 */
const ORDINARIES = {
  chief: { 
    name: 'Chief', 
    ...
    blazonPlural: null // Chiefs don't multiply
  },
  base: { 
    name: 'Base', 
...
// Shield shape - now using single default shape
// 🪝 FUTURE EXPANSION: To re-enable multiple shield shapes, uncomment SHIELD_TYPES
// and re-add the Shield Shape section in the UI below
/*
const SHIELD_TYPES = [

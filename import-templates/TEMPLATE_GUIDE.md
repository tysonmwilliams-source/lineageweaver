...
3. **Import** using the Import/Export Manager in LineageWeaver
...
If you need help building out a complex family, Claude can help you:
1. Design the family structure
2. Fill in the template with your worldbuilding details
3. Validate the JSON before import
4. Debug any issues after import

Just share your family tree requirements and we'll build it together!
